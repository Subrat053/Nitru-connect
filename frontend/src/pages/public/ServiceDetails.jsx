...
const ServiceDetails = ({ onOpenQuote }) => {
  ...
  const fallbackServices = {
    ...
    'business-energy': {
      ...
      related: [
        { title: 'Water & Sewerage', slug: 'water-bills', category: 'Utilities', desc: 'Sewerage and retail water audit savings.' },
        { title: 'Waste Management', slug: 'waste-management', category: 'Utilities', desc: 'Commercial waste disposal schedules.' }
      ]
    },
    'water-bills': {
      ...
      faqs: [
        { question: 'Can businesses choose their water provider?', answer: 'Yes, in regions, commercial customers can choose their retail water provider.' }
      ],
      related: [
    ...
    'waste-management': {
      ...
      related: [
        { title: 'Electric & Gas', slug: 'business-energy', category: 'Utilities', desc: 'Electricity and gas supplier auditing.' },
        { title: 'Water & Sewerage', slug: 'water-bills', category: 'Utilities', desc: 'Wastewater charge audits.' }
      ]
    },
    'business-funding': {
