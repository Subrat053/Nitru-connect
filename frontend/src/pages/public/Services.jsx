...
const iconMap = {
  ...
  'water-bills':          <Droplets className="text-primary" size={24} />,
  'waste-management':     <Trash2 className="text-primary" size={24} />,
...
const staticServices = [
  ...
  },
  {
    ...
    slug: 'water-bills',
    category: 'Utilities',
    shortDescription: 'Sewerage audits and commercial retail water supplier switching.',
    benefits: ['Meter refund billing audits', 'Smart meter leak alerts', 'Lower wholesale retail margins'],
  },
  {
    title: 'Waste Management',
    slug: 'waste-management',
    category: 'Utilities',
    shortDescription: 'Commercial garbage and recycling schedules tailored to business size.',
    benefits: ['Compliance Duty of Care handling', 'Save up to 30% on disposal tax', 'Flexible collection bins schedules'],
  },
  {
