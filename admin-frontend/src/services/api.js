...
export const api = {
  ...
  getServicesAdmin: () => request('/services/admin/services'),
  ...
  // Admin Testimonials
  getTestimonialsAdmin: () => request('/testimonials/admin/testimonials'),
  ...
  // Admin Partners
  getPartnersAdmin: () => request('/partners/admin/partners'),
